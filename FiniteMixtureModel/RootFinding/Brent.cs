...
namespace FiniteMixtureModel.RootFinding
{
    public class Brent
    {
        ...
        // cite source: https://rosettacode.org/wiki/Roots_of_a_function#Brent.27s_Method
        public static double Find(Func f, double lower, double upper, double tol, uint maxIter)
        {
            double a = lower;
            double b = upper;
            ...
            throw new AggregateException("The solution does not converge!");
        }
    }
}
