        ...
        bool ValidAddGlcNAcBranch()
        {
            for(int i = 0; i < 2; i++)
            {
                ...
                if(table_[i + 4] > 0)
                {
                    for (int j = 0; j < 2; j++)
                    {
                        if (j == 0 || table_[i * 2 + j + 6] < table_[i * 2 + j + 5]) // make it order
                        {
        ...
        bool ValidAddGal()
        {
            for (int i = 0; i < 2; i++)
            {
                if (table_[i + 4] > 0)
                {
                    for (int j = 0; j < 2; j++)
                    {
                        if (j == 0 || table_[i * 2 + j + 10] < table_[i * 2 + j + 9]) // make it order
                        {
        ...
        bool ValidAddFucTerminal()
        {
            for(int i = 0; i < 2; i++)
            {
                if (table_[i + 4] > 0)
                {
                    ...
                    for(int j = 0; j < 2; j++)
                    {
                        if (j == 0 || table_[i * 2 + j + 14] < table_[i * 2 + j + 13]) // make it order
                        {
